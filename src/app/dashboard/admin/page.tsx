                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      {(() => {
                        ...
                        Object.entries(stats.classByGrade).forEach(
                          ([grade]) => {
                            gradeData[grade] = {
                              IPA: 0,
                              IPS: 0,
                        ...
                        Object.entries(stats.classByGrade).forEach(
                          ([grade, total]) => {
                            ...
                            const otherCount =
                              total - ipaCount - ipsCount - bahasaCount;
                        ...
                        const maxTotal = Math.max(
                          ...Object.entries(gradeData).map(([, sections]) =>
                        ...
                        return Object.entries(gradeData).map(
                          ([grade, sections]) => {
